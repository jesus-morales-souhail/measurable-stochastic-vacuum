...
**Code:** [`scripts/r1_sandwich_falsifiers.py`](../scripts/r1_sandwich_falsifiers.py)  
**Results:** [`results/r1_falsifiers/`](../results/r1_falsifiers/)  
**Depends on:** [`r1-derivation-sandwich.md`](r1-derivation-sandwich.md) · [`wp5-falsification.md`](wp5-falsification.md) · [`lensing-rms-forecast-real-data.md`](lensing-rms-forecast-real-data.md)
...
See [`lensing-rms-forecast-real-data.md`](lensing-rms-forecast-real-data.md) for operator honesty.
...
Levels aligned with [`wp5-falsification.md`](wp5-falsification.md): F1/F2 failures are **L2** (candidate death for this principle form), not L0 identity failure.
