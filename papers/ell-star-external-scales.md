...
**Code:** [`scripts/ell_star_external_scales.py`](../scripts/ell_star_external_scales.py)  
**Parent:** [`r1-open-kernel.md`](r1-open-kernel.md) · [`r1-counting-principle.md`](r1-counting-principle.md)
...
```bash
python scripts/ell_star_external_scales.py
```
