...
**Code:** [`scripts/h0_desqueezing_filter.py`](../scripts/h0_desqueezing_filter.py)  
...
| \(\theta\sim 0.47\) because transition is at \(z\sim 0.5\)–\(0.7\) | **Post-hoc fit** of the free parameter to the known answer (`BOUNDARY`: no fit of \(\ell_*/r/\theta\) to the gap) |
...
\[
\biggl\lvert\frac{\delta H}{H}\biggr\rvert_{\mathrm{from\ residual}}
\;\lesssim\;
\sigma_X
\;<\;
1.5\times 10^{-4}
