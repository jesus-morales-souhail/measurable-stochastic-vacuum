...
| $s_{\mathrm{loc}}$ | $\lvert\gamma-1\rvert(\sigma_X=2.5\times 10^{-2},\varepsilon=1,z=0.5)$ | wall formula |
| $H_0^{\mathrm{true}}$ | $67.4$ | Planck-class fiducial for toy |
| Observed ratio | $73/67.4\approx 1.083$ | literature anchor only |

**Forbidden:** adjust $\ell_{\ast}$ or $s_{\mathrm{loc}}$ so that the ratio becomes $1.083$.
...
| $\ell_{\ast}$ | $\delta(0.15)$ | $\delta(1.5)$ | $H_0(0.15)/H_0(1.5)$ | vs obs $1.083$ |
|:-----------|:-----------------|:----------------|:-----------------------|:-----------------|
...
| $\ell_{\ast}$ | ratio $H_0(0.15)/H_0(1.5)$ | vs $1.083$ |
|:-----------|:----------------------------|:-------------|
...
| ID | Claim | Evidence |
|:---|:------|:---------|
| T1 | $\ell_{\ast}$ NP-A and $R_8$ fixed a priori | counting / $R_8$ def |
