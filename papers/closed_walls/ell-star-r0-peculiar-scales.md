# Independent clustering lengths vs NP-A $\ell_{\ast}$
...
**Date:** July 2026  
**Status:** External-scale test — **not** a derivation of $\ell_{\ast}$  
...
The open R1 question is whether a **mesoscopic** counting cell $\ell_{\ast}$ is fixed by physics. NP-A gives the **arithmetic** value
...
| Principle fixing $\ell_{\ast}$ | **Still absent (declared)** |
| Scope if $\ell_{\ast}$ ever derived | Residual / slip band — **not** $9\%$ $H_0$ |
