...
| **L3 — Package death** | Every viable path to mesoscopic $\sigma$ or derived hard gain is excluded | Close programme as “limits + geometry only” (honest success of related repository) |
...
> The empirical related repositorysitory already succeeded as **limits and exclusions**.
