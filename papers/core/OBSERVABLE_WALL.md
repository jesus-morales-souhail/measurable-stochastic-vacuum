...
The isotropic fractional residual amplitude of the dark-energy density is bounded by the related BAO analysis as $\sigma_X$.
...
\mathrm{RMS}_{\mathrm{path}} = \lvert\gamma-1\rvert_{\mathrm{loc}} \sqrt{\frac{\chi(z_s)}{\ell_{\ast}}}. \tag{P}
...
\mathrm{RMS}_{\mathrm{path}} = \lvert\gamma-1\rvert_{\mathrm{loc}}\sqrt{\frac{\chi(z_s)}{\ell_{\ast}}}.
