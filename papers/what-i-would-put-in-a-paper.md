...
- $\sigma_X<1.5\times 10^{-4}$ (95% CL) from the sister DESI analysis  
...
**Leave for appendix or offline:** `closed_walls/`, long work packages, side analogies, exploratory sister repo.
