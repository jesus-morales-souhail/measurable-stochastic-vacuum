...
|:-----|:---------|:-------|
| **This programme** | \(\mathrm{RMS}_{\mathrm{path}}=\lvert\gamma-1\rvert_{\mathrm{loc}}\sqrt{\chi/\ell_*}\) for iid patches | Verified **kinematics** for hand-placed \(\sigma_0,r\) ([`NARROW_PATH.md`](../core/NARROW_PATH.md)) |
...
Any “first positive evidence” language **must** list these as first-line null hypotheses ([`NARROW_PATH.md`](../core/NARROW_PATH.md) §5.1).
