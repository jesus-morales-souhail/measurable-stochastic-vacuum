...
## 1. Repository roles (should remain separate)
...
## 5. Reading guide points

| Repo | Start |
|:-----|:------|
| DESI empirical | `manuscript/PREPRINT.md` + `manuscript/CLAIMS.md` |
| Theory | `papers/core/FOR_REFEREES.md` → `OBSERVABLE_WALL.md` → `PAST_LIGHT_CONE_INTEGRATION.md` → `SIMPLE_AS_LAMBDA.md` → `VERIFIED_RESULTS.md` |
