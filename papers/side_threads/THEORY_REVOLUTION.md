...
|:-----|:----------------------|:--------|:----------------|
| **R1** | Continuum / global holographic count for the DE sector | Cell $\ell_*$, $N_{\mathrm{eff}}=(L/\ell_*)^d$, $\sigma_{0,\mathrm{eff}}=(\ell_*/L)^{d/2}$ | Kinematics verified; principle for $\ell_*$ **open** ([`r1-open-kernel.md`](../r1_kernel/r1-open-kernel.md)) |
