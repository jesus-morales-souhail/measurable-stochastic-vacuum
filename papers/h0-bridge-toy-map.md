...
**Code:** [`scripts/h0_bridge_toy.py`](../scripts/h0_bridge_toy.py)  
**Parent:** [`h0-running-brachistochrone-bridge.md`](h0-running-brachistochrone-bridge.md) · [`r1-open-kernel.md`](r1-open-kernel.md) · [`OBSERVABLE_WALL.md`](OBSERVABLE_WALL.md)
