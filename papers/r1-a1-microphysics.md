...
**Depends on:** [`r1-derivation-sandwich.md`](r1-derivation-sandwich.md) · [`r1-mechanism-candidates.md`](r1-mechanism-candidates.md) · [`OBSERVABLE_WALL.md`](OBSERVABLE_WALL.md)
...
| **Literature** | Unimodular gravity corpus; programme [`OBSERVABLE_WALL.md`](OBSERVABLE_WALL.md), [`TOPOLOGICAL_EDGE_ANALOGY.md`](TOPOLOGICAL_EDGE_ANALOGY.md) (pedagogy only for CM analogy). |
...
| **Ref.** | [`inflation-spectator-seed-gordon-wands.md`](inflation-spectator-seed-gordon-wands.md) |
