...
**Code:** [`scripts/r1_t1_mechanisms_compute.py`](../scripts/r1_t1_mechanisms_compute.py)  
**Depends on:** [`r1_sigma_R_full.py`](../scripts/r1_sigma_R_full.py) · [`r1-mechanism-candidates.md`](r1-mechanism-candidates.md)
...
From [`r1_sigma_R_full.py`](../scripts/r1_sigma_R_full.py):
